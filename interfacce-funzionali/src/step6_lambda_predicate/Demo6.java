package step6_lambda_predicate;
...
public class Demo6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------stampa con lambda function Consumer--------------");
		// nuovo metodo di stampa con funzione lambda Consumer
		// richiede un'interfaccia funzionale di tipo Consumer: vuole un parametro e restituisce void
		listaLibriComp.forEach(libro -> System.out.println(libro));
		

		System.out.println("--------------stampa con lambda function Predicate + Comparator + Consumer--------------");
		// nuovo metodo di stampa con funzione lambda Predicate
		// richiede un'interfaccia funzionale di tipo predicate: vuole un parametro e restituisce boolean
		listaLibriComp
			.stream() // trasforma lista in uno stream per permettere l'uso delle lambda
			.filter(libro -> libro.getPrezzo() < 20) // Predicate: filtra la lista
			.sorted(( l1,l2) ->  l1.getPagine() - l2.getPagine()) // Comparator: ordina per pagine crescente
			.forEach(libro -> System.out.println(libro)); // Consumer: stampa la lista
